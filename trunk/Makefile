...
icons.c:	icons/
		...
		gdk-pixbuf-csource --raw --name icon_folder icons/folder.png >> icons.c
...
lua_ext.o:	lua_ext.c lua_ext.h lua_asn1.c  lua_bit.c  lua_bytes.c lua_card.c lua_log.c  lua_ui.c
		$(CC) $(CFLAGS) -Wno-write-strings $<
